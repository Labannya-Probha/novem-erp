        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <Panel title="Revenue by category">
              ...
              {Object.keys(data.revByCat).length === 0 && (
                <p className="text-sm text-pine/40">No revenue in range.</p>
              )}
            </Panel>
            <Panel title="Collections by method">
              ...
              {Object.keys(data.payByMethod).length === 0 && (
                <p className="text-sm text-pine/40">No collections in range.</p>
              )}
            </Panel>
          </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                ...
                {data.dueList.length === 0 && (
                  <tr><td className="td text-pine/40" colSpan={3}>No outstanding dues — all checked-out guests settled.</td></tr>
                )}
              </tbody>
            </table>
          </div>
