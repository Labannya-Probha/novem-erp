                  ...
                  <tr key={q.id} className="hover:bg-leaf/20">
                    ...
                    <td className="td">
                      <div className="flex gap-1.5 justify-end items-center">
                        {/* Edit — pencil icon like voucher */}
                        <button
                          onClick={() => editQuote(q)}
                          title="Edit quotation"
                          className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-leaf text-pine/50 hover:text-forest transition-colors"
                        >
                          <Pencil size={14} />
                        </button>
                        {/* Print */}
                        <button
                          onClick={() => {
                            setEditingQuoteId(q.id)
                            setRoomRate(q.room_rate ?? roomRate)
                            setRoomCount(q.room_count ?? roomCount)
                            setDisc(q.discount_pct ?? disc)
                            setValidDays(q.valid_days ?? validDays)
                            printQuote()
                          }}
                        ...
                        <button
                          ...
                          title={guest?.phone ? 'Send via WhatsApp' : 'No phone number on file'}
                          disabled={!guest?.phone}
                          className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-green-100 text-pine/50 hover:text-green-600 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                        >
                        ...
                        <button
                          ...
                          className="w-7 h-7 flex items-center justify-center rounded-lg hover:bg-blue-50 text-pine/50 hover:text-blue-600 transition-colors"
                        >
                          <Mail size={14} />
                        </button>
                      </div>
